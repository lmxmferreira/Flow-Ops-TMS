-- ============================================================
-- Migration: 004_rating_seed.sql
-- Seed data only — tables already created by 004_rating_v2.sql
-- ============================================================
...
DECLARE
    ...
    v_lane_parcel UUID;
BEGIN
    -- carriers table uses status_id (lookup), pick any carrier
    SELECT carrier_id INTO v_carrier_id
    FROM tms.carriers LIMIT 1;
    ...
    -- Fuel Surcharges (using new columns added to existing table)
