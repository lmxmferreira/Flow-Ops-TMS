...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3001", "http://172.18.101.205:3001", "http://localhost:3000", "http://172.18.101.205:3000"],
    allow_credentials=True,
    allow_methods=["*"],
    allow_headers=["*"],
)

app.include_router(nfr_ac.router,          prefix="/api/v1/system",             tags=["system"])
